...
namespace LapinerTools.Steam.Data
{
	...
	{
		// Token: 0x060001A6 RID: 422 RVA: 0x000096AC File Offset: 0x000078AC
		public static string ERROR_MSG(EResult p_result)
		{
			...
			case EResult.k_EResultExpired:
				return "License/guest pass is expired!";
			case EResult.k_EResultAlreadyRedeemed:
				return "Guest pass has already been redeemed by account, cannot be used again!";
			...
			case EResult.k_EResultAlreadyOwned:
				return "All the games in this guest pass redemption request are already owned!";
			...
			case EResult.k_EResultDiskFull:
				return "Operation canceled, because not enough disk space!";
			case EResult.k_EResultRemoteCallFailed:
				return "A remote call or IPC call failed!";
			...
			case EResult.k_EResultAccountLogonDeniedVerifiedEmailRequired:
				return "Account logon denied, verified e-mail required!";
		...
		// Token: 0x060001A7 RID: 423 RVA: 0x00009AA3 File Offset: 0x00007CA3
		public static ErrorEventArgs CreateSteamNotInit()
		{
			return new ErrorEventArgs("Steam must be running!");
		}

		// Token: 0x060001A8 RID: 424 RVA: 0x00009AAF File Offset: 0x00007CAF
		...
		// Token: 0x060001A9 RID: 425 RVA: 0x00009ABB File Offset: 0x00007CBB
		public static ErrorEventArgs Create(EResult p_result)
		{
			return new ErrorEventArgs(ErrorEventArgs.ERROR_MSG(p_result));
		}

		// Token: 0x060001AA RID: 426 RVA: 0x00009AC8 File Offset: 0x00007CC8
		public ErrorEventArgs()
		{
			base.IsError = true;
		}

		// Token: 0x060001AB RID: 427 RVA: 0x00009AD7 File Offset: 0x00007CD7
